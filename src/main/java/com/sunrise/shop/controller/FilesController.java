...
import com.sunrise.shop.message.ResponseMessage;
import com.sunrise.shop.model.FileInfo;
...
public class FilesController {
    ...
    public ResponseEntity<ResponseMessage> uploadFile(@RequestParam("file") MultipartFile file) {
        ...
        try {
            ...
            message = "Uploaded the file successfully: " + FilesStorageServiceImpl.counter + ".jpg";
